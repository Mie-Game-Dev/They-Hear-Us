...
namespace FOW
{
    ...
    public class FogOfWarWorld : MonoBehaviour
    {
        ...
        public FogOfWarAppearance FogAppearance { get; private set; }
        ...
        {
            //todo: remove all fog of war user-facing funcionality from the server (I.E: do not create materials, etc..)
...
/*
    ...
    public class FogOfWarWorldEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (fow.FogAppearance != FogOfWarWorld.FogOfWarAppearance.None)
            {
            ...
            else if (fow.FogAppearance == FogOfWarWorld.FogOfWarAppearance.Outline)
            {
